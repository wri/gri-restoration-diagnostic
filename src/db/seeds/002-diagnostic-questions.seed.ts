  ...
  try {
    ...
    const questionsData: Array<{
      ...
      // MOTIVATE (1-8)
      {
        ...
        strategyExamples: sanitizeListText('Conduct a benefit-cost analysis comparing (a) likely benefits generated from the restored landscape, (b) likely costs of restoring the target landscape, and (c) likely costs and benefits of the status quo use of the landscape.'),
        sortOrder: 1,
      },
      {
        questionCode: 'M02',
      ...
      },
      {
        ...
        strategyExamples: sanitizeListText('Engage scientists (e.g., biologists, ecologists, hydrologists, soil scientists) to identify which environmental benefits could be generated from restoration efforts.'),
        sortOrder: 3,
      },
      {
        questionCode: 'M04',
        ...
        strategyExamples: sanitizeListText('Produce awareness-raising materials and campaigns via newspapers, radio, television, internet, and/or site visits, depending on the target audience\nIntroduce and/or leverage existing national restoration activities such as public or school tree planting programs.'),
        sortOrder: 4,
      },
      {
        questionCode: 'M05',
        ...
        strategyExamples: sanitizeListText('Conduct a Restoration Opportunities Assessment Methodology planning activity. This is a comprehensive restoration planning resource available online https://iucn.org/resources/grey-literature/guide-restoration-opportunities-assessment-methodology-roam'),
        sortOrder: 5,
      },
      {
        questionCode: 'M06',
        ...
        strategyExamples: sanitizeListText('Conduct and communicate research that quantifies and visualizes the extent to which restored ecosystems can prevent or mitigate natural humanitarian disasters and save money on mitigation efforts when proper planning and prevention are implemented.\nWhen disasters occur, immediately publicly communicate the benefits of restoration.'),
        sortOrder: 6,
      },
      {
        questionCode: 'M07',
        ...
        strategyExamples: sanitizeListText('Establish government law (or industry policy) that requires land managers to allow vegetation recovery or to replant vegetation in areas that have been cleared due to their own commercial activity (e.g., logging, mining, etc.).'),
        sortOrder: 7,
      },
      {
        questionCode: 'M08',
      ...
      },
      {
        ...
        strategyExamples: sanitizeListText('Implement program to remove invasive plants (e.g., using fast-growing native trees to shade out invasives, using goats, appropriate use of fire).\nImplement program to exclude unwanted roaming livestock (e.g., incentives and training for fences).'),
        sortOrder: 10,
      },
      {
        questionCode: 'E03',
      ...
      },
      {
        ...
        strategyExamples: sanitizeListText('Encourage growth of markets (both supply and demand) for commodity products (timber, agricultural products) and environmental products (carbon, water, biodiversity) derived from restored landscapes.\nProvide low-interest financing for businesses directly involved in the restoration value chain.'),
        sortOrder: 13,
      },
      {
        questionCode: 'E06',
        ...
        strategyExamples: sanitizeListText('Reform policies to ensure that land managers have clear and secure rights to land and the natural resources (e.g., trees) on their land.'),
        sortOrder: 14,
      },
      {
        questionCode: 'E07',
        ...
        strategyExamples: sanitizeListText('Conduct an assessment to identify existing policies that might impact the efficacy and efficiency of ecosystem restoration, determine whether or not each is mutually supportive, and recommend policy reforms to achieve greater alignment.'),
        sortOrder: 15,
      },
      {
        questionCode: 'E08',
        ...
        strategyExamples: sanitizeListText('Establish laws that restrict cutting or clearing of remaining natural ecosystems. Establish, strengthen, and enforce legal and regulatory frameworks that restrict the cutting, clearing, or conversion of remaining natural ecosystems, ensuring long-term protection of critical habitats and ecological functions.'),
        sortOrder: 16,
      },
      {
        questionCode: 'E09',
      ...
      },
      {
        ...
        strategyExamples: sanitizeListText('Create a national, state, local or watershed-level Ecosystem Restoration Platform or Committee that articulates roles and responsibilities among government, civil society, academic, and private sector entities and other relevant stakeholders.'),
        sortOrder: 20,
      },
      {
        questionCode: 'E13',
        ...
        strategyExamples: sanitizeListText('Within government, create an interministerial Ecosystem Restoration Task Force charged with coordinating government (national, state, municipal) activities on restoration.\nCreate a multisector stakeholder restoration initiative that sets the vision and coordinates restoration activities across the landscape (e.g., the Brazilian Atlantic Forest PACT).'),
        sortOrder: 21,
      },
      // IMPLEMENT (22-31)
      {
      ...
      },
      {
        ...
        strategyExamples: sanitizeListText('Create and mobilize a broad constituency (representing multiple sectors including agriculture) that keeps restoration on the national political agenda.'),
        sortOrder: 23,
      },
      {
        questionCode: 'I03',
      ...
      },
      {
        ...
        strategyExamples: sanitizeListText('Develop an ecosystem restoration plan informed by the best science and factoring in climate change.\nReview restoration plans of successful restoration experiences elsewhere to gain insights on best practice.'),
        sortOrder: 26,
      },
      {
        questionCode: 'I06',
        ...
        strategyExamples: sanitizeListText('Introduce measures that increase the productivity per hectare of crops, livestock, or timber from existing agricultural and forestry lands\nIntroduce measures that decrease demand for crops, livestock, or timber'),
        sortOrder: 27,
      },
      {
        questionCode: 'I07',
      ...
      },
      {
        ...
        strategyExamples: sanitizeListText('Whenever possible, establish a baseline (e.g., photos, satellite imagery, data on hectares and other measurements from the landscape as it is) to enable comparisons over time.\nDevelop and implement a performance monitoring system (including remote sensing monitoring and ground-level participatory monitoring).'),
        sortOrder: 30,
      },
      {
        questionCode: 'I10',
        ...
        strategyExamples: sanitizeListText('Publicly communicate restoration progress, success stories, and lessons learned. Ensure the stories connect with the target audiences (e.g., images of progress, stories of benefits to people).'),
        sortOrder: 31,
      },
    ]
