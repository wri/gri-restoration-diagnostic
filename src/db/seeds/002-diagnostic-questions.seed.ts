 ...
 * Source: RestorationDiagnosticToo_QuestionDataStructure.csv
 * Guidance is now embedded in Question fields (definition, considerations, strategyExamples)
 */
export async function seedDiagnosticWithQuestions() {
  ...
  const questions = [
    // MOTIVATE Theme (8 questions)
    {
      ...
      considerations: 'Consider economic benefits (jobs, income), ecological benefits (biodiversity, water quality), and social benefits (community well-being)',
    ...
    },
    {
      ...
      considerations: 'Economic viability includes job creation, sustainable livelihoods, and long-term financial returns',
    ...
    },
    {
      ...
      considerations: 'Awareness should span local communities, government officials, and private sector',
    ...
    },
    {
      ...
      considerations: 'Champions can be government officials, community leaders, celebrities, or private sector leaders',
    ...
    },
    {
      ...
      considerations: 'Crises can be natural disasters, health emergencies, or economic shocks linked to degradation',
    ...
    },
    {
      ...
      considerations: 'Response plans should integrate nature-based solutions and restoration approaches',
    ...
    },
    {
      ...
      considerations: 'Include national laws, international commitments, corporate regulations, and enforcement mechanisms',
    ...
    },
    {
      ...
      considerations: 'Identify harmful subsidies (e.g., for deforestation) vs. beneficial ones (e.g., PES programs)',
    ...
    // ENABLE Theme (13 questions)
    {
      questionCode: 'E1',
      theme: Theme.ENABLE,
      enablingCondition: 'a. Ecological conditions',
      ...
      considerations: 'Assess soil health, water availability, seed banks, and ecosystem resilience',
    ...
    },
    {
      ...
      considerations: 'Availability includes wild collection, nurseries, seed banks, and natural regeneration',
    ...
    },
    {
      ...
      considerations: 'Identify and assess controllability of major threats including fire, overgrazing, invasive species, pollution',
    ...
    },
    {
      questionCode: 'E4',
      theme: Theme.ENABLE,
      enablingCondition: 'b. Market conditions',
      ...
      considerations: 'Products can include timber, NTFPs, carbon credits, ecosystem services payments',
    ...
    },
    {
      ...
      considerations: 'Infrastructure includes processing facilities, storage, transportation, and market access',
    ...
    },
    {
      questionCode: 'E6',
      theme: Theme.ENABLE,
      enablingCondition: 'c. Policy conditions',
      ...
      considerations: 'Policies should address land tenure, resource rights, financing mechanisms, and technical support',
    ...
    },
    {
      ...
      considerations: 'Secure tenure is essential for long-term restoration investment and sustainability',
    ...
    },
    {
      questionCode: 'E8',
      theme: Theme.ENABLE,
      enablingCondition: 'd. Social conditions',
      ...
      considerations: 'Support includes active participation, buy-in from leaders, and alignment with livelihoods',
    ...
    },
    {
      ...
      considerations: 'Gender equity includes decision-making, labor distribution, benefit access, and capacity building',
    ...
    },
    {
      ...
      considerations: 'Respect includes FPIC, benefit-sharing, traditional governance, and cultural practices',
    ...
    },
    {
      questionCode: 'E11',
      theme: Theme.ENABLE,
      enablingCondition: 'e. Institutional conditions',
      ...
      considerations: 'Capacity includes technical expertise, administrative systems, coordination mechanisms',
    ...
    },
    {
      ...
      considerations: 'Platforms should include government, civil society, private sector, communities, and researchers',
    ...
    },
    {
      ...
      considerations: 'Corruption can divert funds, create unfair access, and erode trust in restoration programs',
    ...
    // IMPLEMENT Theme (10 questions)
    {
      ...
      enablingCondition: 'a. Leadership',
      ...
      considerations: 'Leadership includes political will, institutional mandates, and resource allocation',
    ...
    },
    {
      ...
      considerations: 'Engagement can be through CSR, supply chain requirements, or business opportunities',
    ...
    },
    {
      ...
      considerations: 'Knowledge includes ecology, agronomy, hydrology, social science, and restoration techniques',
    ...
    },
    {
      ...
      considerations: 'Sharing mechanisms include training programs, peer networks, publications, and digital platforms',
    ...
    },
    {
      questionCode: 'I5',
      theme: Theme.IMPLEMENT,
      enablingCondition: 'c. Technical design',
      ...
      considerations: 'Plans should consider site conditions, native species, ecosystem functions, and climate change',
    ...
    },
    {
      ...
      considerations: 'Integration ensures restoration supports food security, income, and cultural values',
    ...
    },
    {
      questionCode: 'I7',
      theme: Theme.IMPLEMENT,
      enablingCondition: 'd. Finance and incentives',
      ...
      considerations: 'Funding sources include public budgets, private investment, international donors, carbon markets',
    ...
    },
    {
      ...
      considerations: 'Incentives can be payments (PES), subsidies, tax breaks, market access, or certification',
    ...
    },
    {
      ...
      considerations: 'Monitoring should cover ecological, social, and economic indicators',
    ...
    },
    {
      ...
      considerations: 'Adaptive management means adjusting strategies based on results and learning',
